...
class life{
    ...
    public:
        ...
        virtual void display()=0; //do nothing function -> pure virtual function -> abstract class
};

//abstract class:- a class that has atleast one pure virtual function is called abstract class
